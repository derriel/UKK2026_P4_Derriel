...
// Namespace untuk helper
namespace App\Helpers;

// Class helper untuk mengelola menu navigasi aplikasi
class MenuHelper
{
    ...
    public static function getMenuGroups()
{
    ...
    {
        // Cek apakah request cocok dengan path (menghilangkan leading slash)
        return request()->is(ltrim($path, '/'));
    }

    // Fungsi untuk mendapatkan SVG icon berdasarkan nama icon
    public static function getIconSvg($iconName)
    {
        // Array asosiatif icon name ke SVG markup
        $icons = [
            ...
            'settings' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 8.5C10.067 8.5 8.5 10.067 8.5 12C8.5 13.933 10.067 15.5 12 15.5C13.933 15.5 15.5 13.933 15.5 12C15.5 10.067 13.933 8.5 12 8.5Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M19.4 12.9999C19.4 12.6739 19.346 12.359 19.247 12.062L21.26 10.311C21.4 10.193 21.451 9.99 21.364 9.815L19.364 6.315C19.278 6.14 19.079 6.057 18.889 6.115L16.422 7.007C16.003 6.701 15.537 6.451 15.038 6.269L14.636 3.648C14.614 3.496 14.495 3.383 14.343 3.383H9.656C9.504 3.383 9.385 3.496 9.363 3.648L8.961 6.269C8.462 6.451 7.996 6.701 7.577 7.007L5.11 6.115C4.92 6.057 4.721 6.14 4.635 6.315L2.635 9.815C2.548 9.99 2.599 10.193 2.739 10.311L4.752 12.062C4.653 12.359 4.599 12.674 4.599 13.0C4.599 13.326 4.653 13.641 4.752 13.938L2.739 15.689C2.599 15.807 2.548 16.01 2.635 16.185L4.635 19.685C4.721 19.86 4.92 19.943 5.11 19.885L7.577 18.993C7.996 19.299 8.462 19.549 8.961 19.731L9.363 22.352C9.385 22.504 9.504 22.617 9.656 22.617H14.343C14.495 22.617 14.614 22.504 14.636 22.352L15.038 19.731C15.537 19.549 16.003 19.299 16.422 18.993L18.889 19.885C19.079 19.943 19.278 19.86 19.364 19.685L21.364 16.185C21.451 16.01 21.4 15.807 21.26 15.689L19.247 13.938C19.346 13.641 19.4 13.326 19.4 12.9999Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
        ...
        // Return SVG berdasarkan nama icon, atau default star icon jika tidak ada
