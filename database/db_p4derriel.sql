...
CREATE TABLE `borrowings` (
  ...
  `status` enum('borrowed','returned','overdue','requested','return_requested') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'borrowed',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `fine` decimal(10,2) NOT NULL DEFAULT '0.00',
  `fine_status` enum('unpaid','paid') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'unpaid',
...
('3KV8zISYOih8PkVGjizj2QSAWTZ970AsrukMUV4A', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '', 1776729701),
...
('NOjaFTQv8DmFRFJ0DDVQ3fpofEP0TWgkct5KkV0S', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/147.0.0.0 Safari/537.36 Edg/147.0.0.0', '', 1776705271),
...
CREATE TABLE `siswa` (
  ...
  `id_siswa` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'Admin Perpustakaan', 'admin@ukk2026.com', NULL, '$2y$12$RqqjaCSwRLVEI/HhR/rPzOvJ5saq25DgFqYTLZD8WEASNp6Opb1uW', NULL, NULL, '2026-04-14 21:39:40', '2026-04-20 17:01:39', 1, '2026-04-20 17:01:39'),
(2, 'Pengguna Perpustakaan', 'pengguna@ukk2026.com', NULL, '$2y$12$EDj1vvaEuULmL0wH0cloI.HctPpxvopSjKDewdoGZhFjyiDidSUHK', 'users/17KGZWPQRP8vsutn1Mb6OSBbyWt9nDJxwzyH2Wdj.jpg', NULL, '2026-04-14 21:40:45', '2026-04-20 10:14:25', 3, '2026-04-20 10:14:25'),
(3, 'Petugas Perpustakaan', 'petugas@perpustakaan.com', NULL, '$2y$12$ypl2rd0tWUyl6CpEGZoZKupVa0P10qtfmiF7jcd8AGnLPHl2WjrBO', NULL, NULL, '2026-04-14 23:02:27', '2026-04-20 10:12:00', 2, '2026-04-20 10:12:00');
