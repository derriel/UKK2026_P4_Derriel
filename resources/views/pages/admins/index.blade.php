...
@section('content')
<x-common.page-breadcrumb pageTitle="Kelola Data Admin" />

<div class="space-y-6">
    <x-common.component-card title="Daftar Data Admin">
            ...
            <table class="w-full text-sm text-gray-700 dark:text-gray-300">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800">
                        ...
                        <td class="px-4 py-3">
                            @if($admin->photo)
                            <img src="{{ asset('storage/' . $admin->photo) }}" alt="Foto" class="w-10 h-10 object-cover rounded-full">
                            @else
                        ...
                        <td class="px-4 py-3">{{ $admin->role?->name ?? '-' }}</td>
                        <td class="px-4 py-3">
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="px-4 py-3 text-center text-gray-500 dark:text-gray-400">Belum ada admin.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
