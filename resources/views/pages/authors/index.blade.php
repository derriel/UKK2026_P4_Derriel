            ...
            <table class="w-full text-sm text-gray-700 dark:text-gray-300">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800">
                        ...
                        <td class="px-4 py-3">{{ $author->description ?? '-' }}</td>
                        <td class="px-4 py-3">
                            <div class="flex justify-center gap-2">
                                <button @click="editAuthor(@js(['id' => $author->id, 'name' => $author->name, 'description' => $author->description]))" class="btn btn-sm btn-outline-primary">
                                    Edit
                                </button>
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="px-4 py-3 text-center text-gray-500 dark:text-gray-400">Belum ada data pengarang.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
