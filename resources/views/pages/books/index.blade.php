            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <tbody>
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex justify-center gap-2">
                                        <button @click="editBook(@js(['id' => $buku->id, 'title' => $buku->title, 'author' => $buku->author, 'isbn' => $buku->isbn, 'publisher' => $buku->publisher, 'publication_year' => $buku->publication_year, 'category' => $buku->category, 'description' => $buku->description, 'stock' => $buku->stock]))" class="btn btn-sm btn-outline-primary">
                                            Edit
                                        </button>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="px-4 py-3 text-center text-gray-500 dark:text-gray-400">Belum ada data buku.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
                ...
                <form x-ref="bookForm" method="POST" enctype="multipart/form-data" :action="editingId ? updateUrlBase + editingId : createUrl">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <input x-model="formData.author" name="author" type="text" placeholder="Masukkan nama pengarang" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white" required>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Penerbit</label>
                            <input x-model="formData.publisher" name="publisher" type="text" placeholder="Masukkan nama penerbit" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input x-model="formData.publication_year" name="publication_year" type="number" placeholder="Masukkan tahun terbit" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                        </div>
                        <div>
