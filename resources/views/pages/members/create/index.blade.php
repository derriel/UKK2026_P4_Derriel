...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah Data Siswa" />

<div class="space-y-6">
    <x-common.component-card title="Form Tambah Siswa">
        <form action="{{ route('members.store') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input name="nis" type="text" value="{{ old('nis') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                </div>
                ...
                <div>
                    ...
                    <input name="phone" type="text" value="{{ old('phone') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                </div>

                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Alamat</label>
                    <textarea name="address" rows="2" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">{{ old('address') }}</textarea>
                </div>
            </div>
