...
<div class="space-y-6">
    <x-common.component-card title="Form Edit Siswa">
        <form action="{{ route('members.update', $siswa->id) }}" method="POST" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input name="kelas" type="text" value="{{ old('kelas', $siswa->kelas) }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                </div>

                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Jurusan</label>
                    <input name="jurusan" type="text" value="{{ old('jurusan', $siswa->jurusan) }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                </div>
