...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah Petugas" />

<div class="space-y-6">
    <x-common.component-card title="Form Tambah Petugas">
        <form action="{{ route('petugases.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
