...
@section('content')
<x-common.page-breadcrumb pageTitle="Tambah Data Penerbit" />

<div class="space-y-6">
    <x-common.component-card title="Form Tambah Penerbit">
        <form action="{{ route('publishers.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input name="city" type="text" value="{{ old('city') }}" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                </div>
